...
public class ResolverApplication {
  ...
  public static class Application {
    ...
    public static class MandatoryParameterArgumentResolver
      ...
      public Object resolveArgument(MethodParameter methodParameter,
        ...
        return MandatoryParameter.builder().userId(webRequest.getHeader("X-User-Id"))
            .serviceId(webRequest.getHeader("X-Service-Id"))
            .requestId(webRequest.getHeader("X-Request-Id"))
            .timestamp(Long.valueOf(webRequest.getHeader("X-Timestamp"))).build();
      }
    }
