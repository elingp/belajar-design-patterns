...
public class ProxyApplication {
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
      ...
      for (Object argument : arguments) {
        if (argument instanceof String) {
          ...
          if (value.equals("")) {
            throw new RuntimeException("argumen tidak boleh ksoong");
          }
        }
      }
      return invocation.proceed();
  ...
  public static class Application {
    ...
    public ProxyFactoryBean customerService() {
      ...
      // nama logInterceptor dan validationInterceptor-nya di infer langsung dari
      // nama method yang dianotasi Bean. Bisa diset manual dengan cara
      // @Bean("nama")
  ...
  public static void main(String[] args) {
    ...
    // eror karena kosong, dicek oleh validationInterceptor
